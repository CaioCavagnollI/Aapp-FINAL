...
const INITIAL_INTEGRATIONS: Integration[] = [
  {
    id: "openai",
    name: "OpenAI GPT-4",
    description: "Geração de prescrições, análise nutricional e respostas do Atlas IA",
  ...
  },
  {
    ...
    description: "Sincronização com dados de saúde do iPhone (passos, frequência cardíaca)",
  ...
  },
  {
    id: "google_fit",
    name: "Google Fit",
    description: "Integração com dados de saúde e atividade física do Android",
    category: "Saúde e Fitness",
